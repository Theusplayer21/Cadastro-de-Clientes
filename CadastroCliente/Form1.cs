...
namespace CadastroCliente
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            EnderecoCliente EnderecoOlinda = new EnderecoCliente() { Logradouro = "Rua 1", Numero = "123", Complemento = "Apto 12", Bairro = "Centro", Municipio = "São Paulo", Estado = "SP", CEP = "12345-678" };
            Clientes Olinda = new Clientes() { Id = 1, Nome = "Olinda Gonçalves", DataNascimento = "09/08/1975", Telefone = "11989413000", Email = "olinda_gg@email.com", Endereco = EnderecoOlinda, Genero = GeneroCliente.Feminino, NomeSocial = "", Etnia = EtniaCliente.Negra, Estrangeiro = false, Tipo = TipoCliente.PF };
            clientes.Add(Olinda);

            EnderecoCliente EnderecoMatheus = new EnderecoCliente() { Logradouro = "Rua 2", Numero = "456", Complemento = "Casa", Bairro = "Centro", Municipio = "São Paulo", Estado = "SP", CEP = "12345-678" };
            Clientes Matheus = new Clientes() { Id = 2, Nome = "Matheus Selpa", DataNascimento = "01/10/1999", Telefone = "11976899264", Email = "matheus_selpa@email.com", Endereco = EnderecoMatheus, Genero = GeneroCliente.Masculino, NomeSocial = "", Etnia = EtniaCliente.Parda, Estrangeiro = false, Tipo = TipoCliente.PJ };
            clientes.Add(Matheus);

            
            EnderecoCliente EnderecoJuliano = new EnderecoCliente() { Logradouro = "Rua 3", Numero = "789", Complemento = "Casa", Bairro = "Centro", Municipio = "São Paulo", Estado = "SP", CEP = "12345-678" };
            Clientes Juliano = new Clientes()
            {
                Id = 3,
                Nome = "Juliano Selpa",
                DataNascimento = "14/04/1974",
                Telefone = "11971211774",
                Email = "juliano_selpa@email.com",
                Endereco = EnderecoJuliano,
